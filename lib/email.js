...
export async function sendPaymentSuccessEmail({
  ...
  const senderEmail = EMAIL_FROM || "payments@mindwave.com";
  ...
  try {
    const response = await fetch(BREVO_API_URL, {
      ...
      body: JSON.stringify({
        ...
        subject: "Payment Successful – Mindwave Credits",
        htmlContent: `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #eee; border-top: none;">
              ...
              <p style="color: #888; font-size: 12px; margin-bottom: 0;">
                ...
                <a href="https://mindwave.com" style="color: #667eea;">mindwave.com</a>
              </p>
            </div>
          </body>
          </html>
  ...
  try {
    const response = await fetch(BREVO_API_URL, {
      ...
      body: JSON.stringify({
        ...
        subject: "Payment Issue – Mindwave Credits",
        htmlContent: `
          <!DOCTYPE html>
          <html>
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
