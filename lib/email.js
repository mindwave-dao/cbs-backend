 ...
 */
export async function processSuccessfulPayment(invoiceId, userEmail, userName, amount, currency) {
  ...
  console.log(`[EMAIL CHECK] invoiceId=${invoiceId} status=SUCCESS emailSent=${currentEmailStatus || 'NO'}`);
