...
export async function sendPaymentSuccessEmail({
  ...
  const senderEmail = EMAIL_FROM || "payments@voat.ai";
  const senderName = EMAIL_FROM_NAME || "VOAT Payments";
  ...
  try {
    const response = await fetch(BREVO_API_URL, {
      ...
      body: JSON.stringify({
        ...
        subject: "Payment Successful – VOAT Credits",
        htmlContent: `
          <!DOCTYPE html>
          <html>
          <head>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #eee; border-top: none;">
              ...
              <p>Your credits will be issued shortly. If you have any questions, please contact our support team.</p>

              <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;">

              <p style="color: #888; font-size: 12px; margin-bottom: 0;">
                — The VOAT Team<br>
                <a href="https://voat.ai" style="color: #667eea;">voat.ai</a>
              </p>
            </div>
          </body>
          </html>
  ...
  try {
    const response = await fetch(BREVO_API_URL, {
      ...
      body: JSON.stringify({
        ...
        subject: "Payment Issue – VOAT Credits",
        htmlContent: `
          <!DOCTYPE html>
          <html>
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #eee; border-top: none;">
              ...
              <p style="color: #888; font-size: 12px;">— The VOAT Team</p>
            </div>
          </body>
          </html>
        `
