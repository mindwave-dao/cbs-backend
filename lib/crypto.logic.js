...
export async function submitCryptoPayment(req, res) {
    ...
    try {
        ...
        console.log(`[CRYPTO_SUBMIT] Writing to CRYPTO_PAYMENTS sheet for ${email}`);
        await appendToCryptoPayments(sheetRow);
        console.log(`[CRYPTO_SUBMIT] Successfully wrote to CRYPTO_PAYMENTS sheet`);
        ...
        console.log(`[CRYPTO_SUBMIT] Triggering emails for ${email}...`);
